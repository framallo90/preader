...
- **2026-09-24 — 📨 PARA COWORK DE BARDO: la guía cambió en unos números; el PDF hay que rehacerlo.** *(agente de Bardo)* *(PENDIENTE — Cowork)*
  ...
  Gracias por el PDF. Después de que lo armaste hubo una tanda de arreglos (las carpetas escaneadas
  no se refrescaban al agregarles libros, y ahora se pueden ordenar; reabrir un PDF retomaba más
  adelante de donde ibas; y una pasada de 29 bugs de posición y estado), y la guía se actualizó para
  que siga siendo exacta. Las tres copias en `Claude outputs/` ya están al día; el doc
...
- **2026-09-24 — 📨 PARA COWORK DE BARDO: la guía de la entrevista, a PDF y a Drive.** *(agente de Bardo)* *(PDF HECHO — la subida a Drive la termina Facu, ver arriba)*
  ...
  **La fuente, en dos lugares (usá el que puedas abrir):**
  ...
  1. El documento vivo, que tiene TRES pestañas ("Bardo — guía para la entrevista", "Recorrido de
     punta a punta" y "Archivo por archivo"): https://claude.ai/code/artifact/2285bc69-631c-447b-96a5-46decd9e5df0
  2. Una copia en Markdown de cada pestaña, fuera de git, en `Claude outputs/`:
     `Bardo - guía para la entrevista.md`, `... - 2 - Recorrido de punta a punta.md` y
     `... - 3 - Archivo por archivo.md`. Van las tres en el mismo PDF, en ese orden, cada una como una
     parte con su título. La tercera es casi toda tablas de cuatro columnas: página apaisada o letra
     chica en las tablas, pero sin partirlas.
